...
const legalContent = {
  ...
  privacy: {
    en: {
      ...
      updated: "Effective date: 14 September 2026",
      translation: "The Urdu version is provided for convenience. If there is any difference in meaning, the English version will control to the extent permitted by law.",
      sections: [
        ["1. Scope of the current service", ["Tashheer.pk is an independent software platform that helps Pakistani businesses prepare, publish, and monitor Facebook and Instagram advertisements. It is not affiliated with, endorsed by, or a partner of Meta Platforms, Inc.", "We currently operate an agency-assisted model: our team helps you create, publish, and manage ads that run on your own Meta ad account, using access you explicitly grant. Meta advertising spend is charged by Meta directly to the payment method on your Meta ad account, not to Tashheer.", "Signing in uses a one-time code sent to your email. Selected language is remembered on your device using local storage."]],
    ...
    ur: {
      ...
      updated: "موثر تاریخ: 14 ستمبر 2026",
      translation: "اردو ترجمہ سہولت کے لیے ہے۔ مفہوم میں فرق کی صورت میں، قانون کی اجازت کی حد تک انگریزی متن کو ترجیح حاصل ہوگی۔",
      sections: [
        ["1. سروس کا دائرہ", ["Tashheer.pk ایک آزاد سافٹ ویئر پلیٹ فارم ہے جو پاکستانی کاروباروں کو Facebook اور Instagram پر اشتہار بنانے، شائع کرنے اور نگرانی میں مدد دیتا ہے۔ یہ Meta Platforms, Inc. کے ساتھ منسلک، توثیق شدہ یا شراکت دار نہیں۔", "ہم فی الحال ایجنسی کی مدد والا ماڈل چلاتے ہیں: ہماری ٹیم آپ کے اپنے Meta اشتہاری اکاؤنٹ پر آپ کی دی گئی رسائی سے اشتہار بنانے، شائع کرنے اور چلانے میں مدد دیتی ہے۔ Meta اشتہاری خرچ Meta آپ کے Meta اشتہاری اکاؤنٹ پر موجود ادائیگی کے ذریعے سے وصول کرتا ہے، تشہیر نہیں۔", "سائن اِن آپ کے ای میل پر بھیجے گئے ایک بار کے کوڈ سے ہوتا ہے۔ منتخب زبان لوکل اسٹوریج کے ذریعے آپ کے آلے پر محفوظ ہوتی ہے۔"]],
